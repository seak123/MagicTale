...
declare module "engine/game/particles/libs/advancedProperty" {
  ...
  export const randomBetween: (v1: number, v2: number, randomSeed?: number) => number;
...
declare module "engine/game/particles/libs/boxShape" {
  ...
  export default class ParticleBoxShape extends ParticleShape {
    ...
    static GetEmitPositionAndDirection(
...
declare module "engine/game/particles/bufferManager" {
  ...
  export function getAdvancedPropertyComputedValue(
...
declare module "engine/game/particles/libs/emitterBurst" {
  ...
  export default class ParticleEmitterBurst {
    ...
    static GetBurstEmitTimeCountList(
      dataBuffer: Float32Array,
      offsetMap: IParticleOffsetMap,
      burstOffsetMap: IParticleEmitterBurstsOffsetMap,
      dst: Array<{
        time: number;
        count: number;
      }>,
...
declare module "engine/game/particles/particle" {
  ...
  export default class Particle extends MeshRenderer {
    ...
    static CalParticleVertexIndicesBuffer(
      dataBuffer: Float32Array,
      offsetMap: IParticleOffsetMap,
    ): {
    ...
    static GetParticleConstantData(
      dataBuffer: Float32Array,
      offsetMap: IParticleOffsetMap,
    ): {
    ...
    static SetSingleParticleVertexBuffer(
      vDataBufferView: Float32Array,
      vDataBufferViewU32: Uint32Array,
      subPositionAndUV: Float32Array[],
      dataBuffer: Float32Array,
      offsetMap: IParticleOffsetMap,
      vertexCount: number,
...
declare module "engine/game/physics/contactPoint" {
  ...
  import { Vector3_READONLY } from "engine/math/vector3";
...
declare module "engine/game/physics/collider" {
  ...
  import { Nullable } from "engine/type";
  const colliderMap: WeakMap<phys3D.Collider, Collider>;
  const colliderEventNames: string[];
  ...
  export default class Collider extends Component {
    ...
    get bounds(): phys3D.Bounds;
    set bounds(v: phys3D.Bounds);
...
declare module "engine/game/physics/rigidbody" {
  import Component from "engine/game/component";
  import { ForceMode } from "engine/game/physics/types";
...
declare module "engine/game/3D/animator/avatar" {
  ...
  export class AvatarBinding {
    ...
    constructor(avatar: Nullable<Avatar>, animator: wxGA.AnimatorComponent, metaAnimator: MetaAnimationComponent, rootNode: Transform3D);
    rebind(animationClips: Array<DeepImmutable<AnimationClip>>): void;
    update(): void;
    dispose(): void;
    getBoneByPath(path: string): Nullable<wxGA.Entity3D>;
    /**
     * This is for some case want to expose some bone in opted avatar. e.g. root bone for cull.
     *
     * @param {string} path
     * @param {string} [name=""]
     * @returns
...
declare module "engine/shared/serialize/resources/physicMaterial" {
  ...
  export function SerializePhysicMaterial(
    this: PhysicMaterial,
    context: any,
  ): {
    content?: object;
...
declare module "engine/shared/serialize/classes/animation" {
  type Animation = import("engine/game/3D/animation").default;
...
declare namespace phys3D {
  export interface Manager {
    ...
    public bindRigidbodyToEntity(rigidbody: phys3D.Rigidbody, entity: wxGA.Entity3D);
    public alignRigidbodyWithEntity(rigidbody: phys3D.Rigidbody, entity: wxGA.Entity3D);
    public unbindRigidbody(rigidbody: phys3D.Rigidbody);
  ...
  export class DynamicRigidbody extends Rigidbody {
    ...
    Sleep: () => void;
    WakeUp: () => void;
    AddExplosionForce: (explosionForce: number, explosionPosition: RawVec3f, explosionRadius: number, upwardsModifier: number, mode: ForceMode) => void;
